...
public class MyFlipKart {
    ...
    public static void main(String[] args) {
        ...
        // Creating Customer --> Nitin
        Customer nitin = new Customer("Nitin Khandelwal","9876987655");
        ...
        nitin.addItemToCart(milkTenPackets);

        // Printing current cart status
        nitin.printCartItems();
        ...
        nitin.addItemToCart(oneCamera);

        // Printing current cart status
        nitin.printCartItems();

        // Customer updating quantity of milk packets from 10 to 15
        nitin.updateItemCount(milkTenPackets,15);
        ...
        System.out.println(nitin.getCurrentOrder());

        // Customer order is moved to shipment
        Shipment s = nitin.getCurrentOrder().moveToShipment();
